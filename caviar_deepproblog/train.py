...
from caviar_deepproblog.neural.caviar_net import CaviarMLP
...
network = Network(caviar_MLP, "caviar_MLP")
network.optimizer = torch.optim.Adam(caviar_MLP.parameters(), lr=0.001)

model = MarkovModel(
    # "/home/whatever/programms/caviar-deepproblog/caviar_deepproblog/problog_files/caviar.pl",
    "/home/nkatz/dev/caviar-deepproblog/caviar_deepproblog/problog_files/caviar_simplified.pl",
    # "/home/yuzer/ncsr/dpl-benchmark/caviar-deepproblog/caviar_deepproblog/problog_files/caviar_timeless.pl",
    [network],
)
